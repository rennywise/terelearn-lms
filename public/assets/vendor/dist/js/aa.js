...
(function ($) {
  ...
  setTimeout(function () {
    if (
      ...
      Number(localStorage.getItem("TereLEARN:Demo:MessageShowed")) < Date.now()
    ) {
      localStorage.setItem(
        "TereLEARN:Demo:MessageShowed",
        Date.now() + 15 * 60 * 1000
      );
      // eslint-disable-next-line no-alert
      alert(
        "You load TERE LEARN : A Cloud-based Learning Management System with K-MEANS Clustering for enhance learning delivery'"
      );
    }
  }, 1000);
  ...
  $container.append('<h5>Customize Tere Learn</h5><hr class="mb-2"/>');
  ...
  $container.append("<h6>Header Shit</h6>");
